...
const JoinTournament = () => {
  ...
  useEffect(() => {
    // console.log(!isMultiplayerPresent , !isTournament , initialTimeRemaining <= 60000 , initialTimeRemaining > 0 , !popupOpen, ShowPopup,!gameStatus);

    if (!isMultiplayerPresent && !isTournament && initialTimeRemaining <= 60000 && initialTimeRemaining > 0 && !popupOpen && ShowPopup && !gameStatus) {
      // setPopupOpen(true);
      // showPopup();
  ...
  }, [initialTimeRemaining, popupOpen, isMultiplayerPresent, ShowPopup, gameStatus]);
